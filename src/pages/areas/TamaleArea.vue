...
const nodes = [
    ...
    },
    {
        ...
        children: [
            {
                label: '38 - SAWLA SUBSTATION (Colour-2022-Model',
                header: 'child',
                icon: 'image',
                type: 'Operating Drawing',
    ...
    },
    {
        ...
        children: [
            {
                label: '81 - ADUBLIYILI SUBSTATION (Colour-2022)',
                header: 'child',
                icon: 'image',
                type: 'Operating Drawing',
...
<template>
    <area-detail area="Tamale Area" :nodes="nodes" />
</template>
